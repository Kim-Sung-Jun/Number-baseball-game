...
public class NumberBaseballGame {
    ...
    public void notThreeStrike() { //스트라이크 갯수 확인메서드
    ...
    public void startOrEnd() { //스트라이크 3개 다 맞추면 안내문 발송메서드
    ...
    public void startOrEnd2(int newNumber) { //재시작 여부메서드
        if (newNumber == 1) {
            start = true;
        } else if (newNumber == 2) {
            start = false;
